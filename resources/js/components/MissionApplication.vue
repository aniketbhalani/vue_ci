        ...
        <tbody>
          <tr v-for="mt in data" :key="mt.mission_application_id">
            ...
            <td class="d-flex justify-content-center pe-4">
              <span
                :id="'application_status_a_' + mt.mission_application_id"
              ...
              <a
                :id="'application_a_' + mt.mission_application_id"
                @click="approveApplication(mt.mission_application_id)"
                v-if="mt.approval_status !== 'APPROVE'"
              >
                <img src="../../../public/Images/correct-icon.svg" alt="hello" style="width: 20px; height: 20px;">
              </a>

              <span
                :id="'application_status_r_' + mt.mission_application_id"
              ...
              <a
                :id="'application_r_' + mt.mission_application_id"
                @click="rejectApplication(mt.mission_application_id)"
                v-if="mt.approval_status !== 'DECLINE'"
              >
                <img src="../../../public/Images/cancle-icon.svg" alt="hello" style="width: 20px; height: 20px;">
              </a>
            </td>
          </tr>
        </tbody>
