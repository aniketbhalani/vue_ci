    ...
    <div class="container-fluid mt-3 px-4 ">
        ...
        <div class="card ">
            <div class="card-header">
                <h2 class="text-center mb-1"> Cms Page</h2>
            </div>
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <a v-for="cmspage in cmspages" :key="cmspage.cms_page_id">
                        <router-link :to="`/cmspage/create`"
                        ...
                        <tbody>
                            <tr v-for="cmspage in cmspages" :key="cmspage.cms_page_id">
                                ...
                                <td>
                                    ...
                                    <router-link :to="`/cmspage/${cmspage.cms_page_id}/edit`"
                                        class="btn btn-outline-warning rounded-pill mt-3 px-4">Edit</router-link>&nbsp;&nbsp;
                                    <button @click="deleteCmsPage(cmspage.cms_page_id)" type="button"
